...
const PDFSuratPermohonan: React.FC = () => {
  ...
  const pdfUrl = `${API_URL}/${ENDPOINTS.PESAN_TEMPAT.LIST_UPDATE_ADD_DELETE_PESAN_TEMPAT}/${params.id}/Attachment/SuratPermohonan`;
  ...
  }, [pdfUrl, auth?.api_token]); // Removed pdfBlobUrl to avoid re-fetching
