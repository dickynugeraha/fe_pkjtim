    ...
    <div className="d-flex align-items-center gap-2 gap-lg-3">
      ...
      {config.app?.toolbar?.daterangepickerButton && (
        <div
          ...
          className={clsx(
            "btn btn-sm fw-bold  d-flex align-items-center px-4 d-none",
            daterangepickerButtonClass
          )}
        >
      ...
      {config.app?.toolbar?.secondaryButton && (
        <a href="#" className="btn btn-sm btn-flex btn-light fw-bold d-none">
          Filter
        </a>
      )}
      ...
      {config.app?.toolbar?.primaryButton && (
        <a
          ...
          className="btn btn-sm fw-bold btn-primary d-none"
        >
          Create
        </a>
      )}
