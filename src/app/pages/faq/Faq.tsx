  ...
  return (
    <Content>
      ...
      <div className="card">
                ...
                <div className="ms-4">
                  ...
                  {itemPemesanan.section1 && (
                    <p>
                      ...
                      ducimus officiis minus commodi nisi cupiditate dolor alias
                      sint cumque recusandae magnam, dolores blanditiis.
                    </p>
                  )}
                </div>
              </div>
        ...
        {/* Video tutorial */}
        <div className="d-flex flex-wrap p-8">
          <div className="me-5">
